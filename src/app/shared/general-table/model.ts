export class TableConfig {
    ...
    constructor(params?: any) {
        ...
        this.searchInSide = params?.searchInSide === void 0 ? true : params.searchInSide;
        ...
        this.paginationOutside = params?.paginationOutside === void 0 ? false : params.paginationOutside;
        this.removePagination = params?.removePagination === void 0 ? false : params.removePagination;
        this.doApiCall = params?.doApiCall === void 0 ? true : params.doApiCall;
        this.loadInternally = params?.loadInternally === void 0 ? true : params.loadInternally;
        this.showCSVTool = params?.showCSVTool === void 0 ? false : params.showCSVTool;
...
export class TableColumn {
    ...
    condition?: (element: any, column: any) => boolean;
    ...
    constructor(params?: any) {
        ...
        this.sortable = params.sortable === void 0 ? true : params.sortable;
        this.sortableFromView = params.sortableFromView === void 0 ? false : params.sortableFromView;
        this.sortingOutside = params.sortingOutside === void 0 ? false : params.sortingOutside;
        ...
        this.showIconBtn = params.showIconBtn === void 0 ? false : params.showIconBtn;
        this.btnClass = params.btnClass === void 0 ? 'btn-info' : params.btnClass;
        this.btnIcon = params.btnIcon || null;

        this.item_name = params?.item_name === void 0 ? 'name' : params.item_name;
        this.obj_item = params?.obj_item === void 0 ? '' : params.obj_item;
        this.condition = params?.condition;

        this.imageUrl = params.imageUrl || '../../../assets/images/default_user.png';
    }
}
